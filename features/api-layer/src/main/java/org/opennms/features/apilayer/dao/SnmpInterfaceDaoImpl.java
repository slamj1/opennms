...
public class SnmpInterfaceDaoImpl implements SnmpInterfaceDao {
    ...
    @Override
    public SnmpInterface findByNodeIdAndDescription(Integer nodeId, String description) {
        return ModelMappers.toSnmpInterface(snmpInterfaceDao.findByNodeIdAndDescription(nodeId, description));
    }
}
