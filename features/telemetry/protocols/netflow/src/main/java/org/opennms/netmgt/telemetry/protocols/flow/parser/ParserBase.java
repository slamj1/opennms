...
import org.opennms.netmgt.telemetry.protocols.flow.parser.ie.values.BooleanValue;
import org.opennms.netmgt.telemetry.protocols.flow.parser.ie.values.DateTimeValue;
import org.opennms.netmgt.telemetry.protocols.flow.parser.ie.values.FloatValue;
import org.opennms.netmgt.telemetry.protocols.flow.parser.ie.values.IPv4AddressValue;
import org.opennms.netmgt.telemetry.protocols.flow.parser.ie.values.IPv6AddressValue;
import org.opennms.netmgt.telemetry.protocols.flow.parser.ie.values.ListValue;
import org.opennms.netmgt.telemetry.protocols.flow.parser.ie.values.MacAddressValue;
import org.opennms.netmgt.telemetry.protocols.flow.parser.ie.values.NullValue;
import org.opennms.netmgt.telemetry.protocols.flow.parser.ie.values.OctetArrayValue;
import org.opennms.netmgt.telemetry.protocols.flow.parser.ie.values.SignedValue;
import org.opennms.netmgt.telemetry.protocols.flow.parser.ie.values.StringValue;
import org.opennms.netmgt.telemetry.protocols.flow.parser.ie.values.UndeclaredValue;
import org.opennms.netmgt.telemetry.protocols.flow.parser.ie.values.UnsignedValue;
