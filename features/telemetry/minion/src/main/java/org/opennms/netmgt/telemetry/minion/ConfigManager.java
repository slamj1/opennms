 ...
 *
 * See {@link ListenerConfig} for a list of supported properties.
 *
 * @author jwhite
 */
public class ConfigManager implements ManagedServiceFactory {
    ...
    public void updated(String pid, Dictionary<String, ?> properties) {
        ...
        try {
//            final Listener listener = ListenerFactory.buildListener(listenerConfig, dispatcher);
//            listener.start();
